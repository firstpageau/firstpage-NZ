    ...
    <div class="block__web_conversion" style="padding: 4rem 0 !important;">
        <div class="section-letstalk section-orange section-letstalk-new">
            <div class="container text-center text-white">
                ...
                <p class="mb-3 p-tag-h2-style"><strong>Claim your 100% free REVENUE</br class="d-none d-lg-block">GROWTH strategy session with an</br class="d-none d-lg-block">experienced digital strategist</br class="d-none d-lg-block"> valued at <?php the_sub_field('value'); ?>.</strong></p>
                <?php else; ?>    
